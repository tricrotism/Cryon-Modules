...
dependencies {
    ...
    // The survival gamemode contract: implements SellService, consumes EconomyService. Provided at
    // runtime from the core's plugins/Cryon/api/ layer, so compileOnly.
...
// The plain `jar` is the deployable artifact: drop build/libs/cryon-shop-<v>.jar into the core
