...
dependencies {
    ...
    // The survival gamemode contract: implements SkillsService, consumes EconomyService (level
    // rewards) and SellService (the sell boost). Provided at runtime from plugins/Cryon/api/.
...
// The plain `jar` is the deployable artifact: drop build/libs/cryon-skills-<v>.jar into the core
