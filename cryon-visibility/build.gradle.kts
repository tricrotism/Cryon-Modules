...
dependencies {
    ...
    // The visibility contract — provided at runtime from the core's plugins/Cryon/api/ layer, so
    // compileOnly here too. Other repos consuming VisibilityService depend on this same jar.
...
// The plain `jar` is the deployable artifact: drop build/libs/cryon-visibility-<v>.jar into the core
// server's plugins/Cryon/modules/ directory. It bundles only this feature's classes; the framework,
// Paper, and kotlin-stdlib come from the core at runtime.
